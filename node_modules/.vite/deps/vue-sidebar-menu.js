...
var initSidebar = function initSidebar2(props, context) {
  ...
  var setMobileItem = function setMobileItem2(_ref) {
    ...
    var _linkEl$getBoundingCl = linkEl.getBoundingClientRect(), linkTop = _linkEl$getBoundingCl.top, linkBottom = _linkEl$getBoundingCl.bottom, linkHeight = _linkEl$getBoundingCl.height;
  ...
  var updateMobileItemRect = function updateMobileItemRect2(_ref2) {
    var top = _ref2.top, height = _ref2.height, padding = _ref2.padding, maxWidth = _ref2.maxWidth, maxHeight = _ref2.maxHeight;
...
function includesParams(outer, inner) {
  var _loop = function _loop2(key2) {
    var innerValue = inner[key2];
    var outerValue = outer[key2];
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return $options.isHyperLink ? (openBlock(), createElementBlock("a", normalizeProps(mergeProps({ key: 0 }, _ctx.$attrs)), [
    renderSlot(_ctx.$slots, "default")
  ], 16)) : (openBlock(), createBlock(_component_router_link, {
    key: 1,
    custom: "",
    to: _ctx.$attrs.href
  }, {
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return $props.item.component && !$setup.isHidden ? (openBlock(), createElementBlock("li", _hoisted_1$2, [
    (openBlock(), createBlock(resolveDynamicComponent($props.item.component), normalizeProps(guardReactiveProps($props.item.props)), null, 16))
  ])) : $props.item.header && !$setup.isHidden ? (openBlock(), createElementBlock("li", mergeProps({
    key: 1,
    class: ["vsm--header", $props.item.class]
  }, $props.item.attributes), toDisplayString($props.item.header), 17)) : !$setup.isHidden ? (openBlock(), createElementBlock("li", mergeProps({
    key: 2,
    ...
    (openBlock(), createBlock(resolveDynamicComponent($setup.linkComponentName ? $setup.linkComponentName : "SidebarMenuLink"), mergeProps({
      ...
      default: withCtx(() => [
        $setup.isCollapsed && $setup.isFirstLevel ? (openBlock(), createBlock(Transition, {
          ...
          default: withCtx(() => [
            $setup.hover ? (openBlock(), createElementBlock("div", {
              key: 0,
              class: "vsm--mobile-bg",
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("span", null, toDisplayString($props.item.title), 1),
          ...
          $setup.hasChild ? (openBlock(), createElementBlock("div", {
            key: 1,
...
var _hoisted_1 = createBaseVNode("span", { class: "vsm--arrow_default" }, null, -1);
var _hoisted_2 = createBaseVNode("span", { class: "vsm--toggle-btn_default" }, null, -1);
