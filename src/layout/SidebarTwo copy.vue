...
const menuList = JSON.parse(localStorage.getItem("menuList")); //console.log('메뉴목록:', menuList);
    ...
    <perfect-scrollbar class="sidebar">
      <div class="sidebar-header">
        ...
        <!-- <img
          ...
          src="@/assets/logo.svg"
          alt=""
          @click="this.$router.push('session/Signin')"
        /> -->
      </div>
      ...
      <div class="bg-secondary-lighten-4 rounded mt-10 text-center">
        ...
        <div class="text-13 f-600 mt-2">{{ name }}</div>
        <div
